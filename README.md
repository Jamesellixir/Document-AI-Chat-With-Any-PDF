...
```text
screenshots/Screenshot 2026-04-17 001521.png
screenshots/Screenshot 2026-04-17 001646.png
screenshots/Screenshot 2026-04-17 001701.png
```
...
- Do not commit `.env`
- Keep the project scoped to single-PDF Q&A for the portfolio version
- See `SECURITY_AUDIT.md` for implementation notes and safeguards
